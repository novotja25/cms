<?php
    ...
    $sql = "SELECT * FROM atrakce ORDER BY nazev ASC";
    $con = $db->prepare($sql);
    $con->execute();
...
<head>
    ...
    <title>Atrakce - administrace</title>
...
<body>
    ...
    <section class="section">
        <div class="container">
            ...
            <h1 class="title">Atrakce</h1>
            <div class="box">
                <h2 class="title is-5">Přidat atrakci</h2>
                <?php
                    if ($errors != null) {
                ...
                ?>
                <form action="atrakce_zapis.php" method="post">
                    <div class="field">
                        <label class="label" for="nazev">Název</label>
                        <div class="control">
                            <input class="input" type="text" id="nazev" name="nazev">
                        </div>
                    </div>
                    <div class="field">
                        <label class="label" for="popis">Popis</label>
                        <div class="control">
                            <textarea class="textarea" id="popis" name="popis"></textarea>
                        </div>
                    </div>
                    <div class="field">
                        <div class="control">
                ...
                <tbody>
                    <?php
                        foreach ($data as $value) {
                            ...
                            echo "</td>";
                            echo "<td>";
                            echo "<a href='atrakce_upravit.php?id=";
                            echo $value["ID_data"];
                            echo "'>Upravit</a> ";
                            echo "<a href='atrakce_smazat.php?id=";
                            echo $value["ID_data"];
                            echo "'>Smazat</a>";
                            echo "</td>";
                            echo "</tr>";
